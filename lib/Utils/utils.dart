...
String? validateInputString(String? value) {
  return value!.isEmpty ? 'Enter a valid email address' : null;
}
...
String? validateNumber(String? value) {
  ...
  // Use a try-catch block to check if the input can be parsed as an integer
  try {
    int parsedValue = int.parse(value);

    // Check if the parsed value is an integer (not a decimal)
